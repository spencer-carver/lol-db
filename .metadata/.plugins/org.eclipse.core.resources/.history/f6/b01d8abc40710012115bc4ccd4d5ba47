...
public abstract class Modifier
{
	...
	private double damagePerLevel;		public double getDamagePerLevel() { return damagePerLevel; }
		public void setDamagePerLevel(double d) { damagePerLevel = d; }
	...
	private double attackSpeedPerLevel;	public double getAttackSpeedPerLevel() { return attackSpeedPerLevel; }
		public void setAttackSpeedPerLevel(double as) { attackSpeedPerLevel = as; }
	...
	private double armorPerLevel;		public double getArmorPerLevel() { return armorPerLevel; }
		public void setArmorPerLevel(double a) { armorPerLevel = a; }
	private double magicResist;		public double getMagicResist() { return magicResist; }
		public void setMagicResist(double mr) { magicResist = mr; }
	private double magicResistPerLevel;	public double getMagicResistPerLevel() { return magicResistPerLevel; }
		public void setMagicResistPerLevel(double mr) { magicResistPerLevel = mr; }
	private double moveSpeed;		public double getMoveSpeed() { return moveSpeed; }
		public void setMoveSpeed(double ms) { moveSpeed = ms; }
	private double moveSpeedMultiplier;	public double getMoveSpeedMultiplier() { return moveSpeedMultiplier; }
		public void setMoveSpeedMultiplier(double ms) { moveSpeedMultipler = ms; }
